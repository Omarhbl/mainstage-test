...
export default async function PeopleArticlesPage() {
  const peopleArticles = (await getSortedPublicArticleCards()).filter((article) =>
    hasArticleCategory(article, "people")
  );
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-[980px] whitespace-nowrap text-[18px] font-body font-normal leading-[1.65] text-[rgba(0,0,0,0.68)]">
                Explore every people story published on Mainstage, from image-driven moments to the personalities shaping the conversation.
              </p>
            </div>
          </div>
